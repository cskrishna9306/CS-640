...
if __name__ == "__main__":
   ...
   while h:
      ...
      packet = struct.pack("!cIHIHIcII", 1, socket.gethostbyname(socket.gethostname()), port, socket.gethostbyname(sender[1]), sender[2], 9 + len(file_name.encode()), bytes("R", "utf-8"), 0, window) + file_name.encode()
   ...
   while file_chunks != 0:
      ...
      packet_header = full_packet[:26]
      packet_header = struct.unpack("!cIHIHIcII", packet_header)
